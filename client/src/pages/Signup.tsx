...
export default function Signup() {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      toast.error((e as Error)?.message ?? "Não foi possível criar a conta.");
    }
  };
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4" style={{ background: "#F3F4F6" }}>
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-md p-8">
        ...
        <button
          onClick={() => toast.info("Cadastro com Google chega em breve. Use e-mail e senha por enquanto.")}
        ...
        <div className="space-y-3">
          ...
          >
            <UserPlus size={16} /> {signupMut.isPending ? "Criando..." : "Criar conta"}
          </button>
        </div>
